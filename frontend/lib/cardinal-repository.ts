...
export const mockCS210Payload: SkillTreePayload = {
  ...
  nodes: [
    ...
    { id: 'skill_4', title: 'Linear Data Structures', shortTitle: 'Linear Struct', description: 'Implement stacks, queues, linked lists, and contiguous arrays.', status: 'mastered', progress: 100, xpReward: 200, prerequisiteIds: ['skill_2'], missionIds: ['m4'], icon: 'database', learningObjective: 'Construct pointer-based singly and doubly linked list memory structures.', estimatedMinutes: 50, moduleName: 'Module 3: Linear Structures', difficultyLabel: 'Intermediate' },
    ...
    { id: 'skill_6', title: 'Sorting & Searching', shortTitle: 'Sort & Search', description: 'Analyze divide-and-conquer sorting algorithms and binary search.', status: 'mastered', progress: 100, xpReward: 220, prerequisiteIds: ['skill_3', 'skill_5'], missionIds: ['m6'], icon: 'code', learningObjective: 'Implement QuickSort partitioning and compare runtime against MergeSort.', estimatedMinutes: 55, moduleName: 'Module 4: Searching & Sorting', difficultyLabel: 'Intermediate' },
    { id: 'skill_7', title: 'Trees & Traversal', shortTitle: 'Trees', description: 'Build binary search trees, AVL trees, and tree traversals.', status: 'in_progress', progress: 45, xpReward: 250, prerequisiteIds: ['skill_5', 'skill_6'], missionIds: ['m7'], icon: 'network', learningObjective: 'Perform single and double rotations on unbalanced BST and AVL tree nodes.', estimatedMinutes: 60, moduleName: 'Module 5: Hierarchical Structures', difficultyLabel: 'Intermediate' },
    { id: 'skill_8', title: 'Hashing & Hash Tables', shortTitle: 'Hashing', description: 'Understand hash functions, collision resolution, and O(1) lookups.', status: 'available', progress: 0, xpReward: 250, prerequisiteIds: ['skill_4'], missionIds: ['m8'], icon: 'database', learningObjective: 'Compare linear probing, quadratic probing, and chaining under high load factor.', estimatedMinutes: 45, moduleName: 'Module 5: Hierarchical Structures', difficultyLabel: 'Intermediate' },
    { id: 'skill_9', title: 'Graph Theory Foundations', shortTitle: 'Graph Theory', description: 'Represent directed graphs, adjacency matrices, and edge lists.', status: 'available', progress: 0, xpReward: 280, prerequisiteIds: ['skill_4'], missionIds: ['m9'], icon: 'network', learningObjective: 'Build space-efficient graph representations for large node vertices.', estimatedMinutes: 50, moduleName: 'Module 6: Graph Networks', difficultyLabel: 'Intermediate' },
    { id: 'skill_10', title: 'Algorithm Analysis', shortTitle: 'Algo Analysis', description: 'Evaluate Big-O, Big-Omega, and Big-Theta asymptotic bounds.', status: 'available', progress: 0, xpReward: 300, prerequisiteIds: ['skill_6'], missionIds: ['m10'], icon: 'brain', learningObjective: 'Determine exact Big-O complexities for nested loops and master theorem recurrences.', estimatedMinutes: 40, moduleName: 'Module 6: Graph Networks', difficultyLabel: 'Intermediate' },
    { id: 'skill_11', title: 'Dynamic Programming', shortTitle: 'Dynamic Prog', description: 'Formulate optimal substructure and memoized state transitions.', status: 'locked', progress: 0, xpReward: 350, prerequisiteIds: ['skill_8', 'skill_10'], missionIds: ['m11'], icon: 'brain', learningObjective: 'Solve 0/1 Knapsack problems using top-down memoization and bottom-up DP tables.', estimatedMinutes: 75, moduleName: 'Module 7: Advanced Algorithmic Strategies', difficultyLabel: 'Advanced' },
